...
const CommentCard = ({ index, leftVl, commentData }) => {
  let {
    commented_by: {
  ...
  return (
    <div className="w-full" style={{ paddingLeft: `${leftVl * 10}px` }}>
      <div className="my-5 p-6 rounded-md border border-grey">
        <div className="flex gap-3 items-center mb-8">
          <img src={profile_img} className="w-6 h-6 rounded-full" alt="" />

          <p className="line-clamp-1">
            {/* if you want to add full name than add {fullname} */}@
        ...
        <div className="flex gap-5 items-center mt-5">
          ...
          <button className="underline" onClick={handelReplyClick}>
            Reply
          </button>
